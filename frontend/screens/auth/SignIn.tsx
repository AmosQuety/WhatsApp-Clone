...
const SignIn = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      let errorMessage = error.response?.data?.error || error.response?.data?.message || 'Invalid credentials';
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Welcome back to the future of messaging</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  form: {
    ...
    padding: 32, // More padding for premium look
    borderRadius: 24,
    borderWidth: 1,
